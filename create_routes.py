"""Write API route files for projects"""
import os

# Create projects [id] route
projects_id_route = """import { NextRequest, NextResponse } from "next/server";
...
path = os.path.join("app", "api", "projects", "[id]", "route.ts")
os.makedirs(os.path.dirname(path), exist_ok=True)
with open(path, "w", encoding="utf-8") as f:
    f.write(projects_id_route)
